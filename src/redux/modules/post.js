...
// 게시글 추가하기
const addPostFB = (title,author,comment) => {
    console.log('===addPostFB===');
  return function (dispatch, getState, { history }) {
    ...
    postDB
        ...
        console.log("addPostFB 할때 post 값",post)
...
const getPostFB = ()=>{
  return function (dispatch, getState, { history }) {
    ...
    let query = postDB.orderBy("title","desc");
